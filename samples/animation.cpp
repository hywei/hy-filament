...
int main(int argc, char** argv)
{
    ...
    auto setup = [&app](Engine* engine, View* view, Scene* scene) {
        ...
        app.ib = IndexBuffer::Builder().indexCount(3).bufferType(IndexBuffer::IndexType::USHORT).build(*engine);
    ...
    FilamentApp::get().animate([&app](Engine* engine, View* view, double now) {
        ...
        vb->setBufferAt(
            *engine, 0, VertexBuffer::BufferDescriptor(verts, 36, (VertexBuffer::BufferDescriptor::Callback)free));

        auto& renderable_manager = engine->getRenderableManager();
        renderable_manager.destroy(app.renderable);
        ...
        transform_manager.setTransform(transform_manager.getInstance(app.renderable),
